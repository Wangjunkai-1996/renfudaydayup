...
register_runtime_routes(
    app,
    parse_since_ts_arg=parse_since_ts_arg,
    to_bool=to_bool,
    build_data_payload=build_data_payload,
...
register_report_routes(
    app,
    to_bool=to_bool,
    normalize_date_str=normalize_date_str,
    get_default_baseline_date=get_default_baseline_date,
    read_debug_log_entries=read_debug_log_entries,
    summarize_debug_entries=summarize_debug_entries,
    read_daily_report_json=read_daily_report_json,
    get_daily_report_paths=get_daily_report_paths,
    generate_daily_report=generate_daily_report,
    get_daily_bundle_path=get_daily_bundle_path,
    read_daily_bundle_json=read_daily_bundle_json,
    generate_daily_bundle=generate_daily_bundle,
    get_or_generate_daily_report=get_or_generate_daily_report,
    ...
    get_db=get_db,
    build_signal_explanation=build_signal_explanation
)
